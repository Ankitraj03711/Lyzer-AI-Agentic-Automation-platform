...
def create_chat_session(user_id: str, title: str = "New Chat"):
    ...
    Uses the Clerk user_id directly to avoid dependency on the users collection.
    """
    try:
        session = {
            "userId": user_id,
        ...
        print(f"Chat session created: {result.inserted_id}")
...
def get_user_sessions(user_id: str):
    ...
    Uses the Clerk user_id directly.
    """
    try:
