...
import { connectGmail } from '@/lib/helpers/socialHelpers';
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Save to Gmail table and update Social table
    ...
    return NextResponse.redirect(new URL('/connections?success=gmail', process.env.NEXT_PUBLIC_APP_URL));
  } catch (error) {
